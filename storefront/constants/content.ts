...
export const ABOUT_MILESTONES = [
  ...
  },
  {
    ...
    description:
      "Kako se posao razvijao, osluškivali smo šta je kupcima zaista potrebno — njihove sugestije su postale naše smernice.",
  },
  {
    title: "Nastao je SG Tools",
    description:
      "Pre 7 godina to znanje smo pretvorili u brend. Danas širimo asortiman i pravimo nove proizvode sa istom pažnjom.",
  },
];
...
export const ABOUT_PARAGRAPHS = [
  ...
  "Materijale biramo promišljeno, sa naglaskom na trajnost i otpornost u realnim uslovima rada. Ergonomija za nas nije dodatak, već polazna tačka — alat mora prirodno ležati u ruci, pružati siguran hvat i omogućiti dugotrajan rad bez nepotrebnog zamora. Dizajn je uvek u službi funkcije, bez suvišnih detalja, sa jasnom namenom da alat bude pouzdan i praktičan u svakodnevnoj upotrebi.",
  "Od izbora sirovina do završne obrade, ništa nije prepušteno slučaju.",
  "Ovo nije brend koji nastaje kompromisima na račun kvaliteta, ali isto tako nije ni brend koji kvalitet čini nedostupnim. Naš cilj je jasan — profesionalni kvalitet po cenama koje imaju smisla.",
  "Nastao iz slušanja, razumevanja i znanja, uz poštovanje iskustva korisnika — pretvarajući ga u konkretna, funkcionalna rešenja.",
  "SG TOOLS je zajednički uspeh koji nastavljamo da gradimo zajedno sa našim kupcima.",
];
